...
import { fmtCurrency, fmtDate, fmtKg, fmtNum, wastageReasonLabel } from "@/lib/inventory/format";
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <div className="flex gap-2 mt-1">
                ...
                />
                <Select
                  value={form.watch("quantity_unit")}
                  onValueChange={(v) => form.setValue("quantity_unit", v)}
                >
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div>
            <Label className="label-caps">
              COA Number {coaLocked && <span className="text-muted-foreground">(locked)</span>}
            </Label>
            {coaLocked ? (
              <div className="mt-1 border rounded-md p-2 text-sm bg-muted/40">
                {material.coa_number}
              </div>
            ) : (
              <Input
          ...
          <div>
            <Label className="label-caps">
              PO Number {poLocked && <span className="text-muted-foreground">(locked)</span>}
            </Label>
            {poLocked ? (
              <div className="mt-1 border rounded-md p-2 text-sm bg-muted/40">
                {material.po_number}
          ...
          <div>
            <Label className="label-caps">
              Invoice Number {invLocked && <span className="text-muted-foreground">(locked)</span>}
            </Label>
            {invLocked ? (
              <div className="mt-1 border rounded-md p-2 text-sm bg-muted/40">
